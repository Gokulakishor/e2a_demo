        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl space-y-16">
          ...
          >
            ...
            <ul className="list-disc list-inside space-y-3.5 text-slate-650 font-light text-sm md:text-md text-justify">
              ...
              <li className="text-justify leading-relaxed">Review articles are not being accepted in this conference.</li>
              <li className="text-justify leading-relaxed">Accepted and presented papers will be published in the <strong className="font-semibold text-slate-800">Springer's "Lecture Notes in Electrical Engineering" (LNEE Scopus Indexed) series proceedings</strong>.</li>
